...
const RelaxWithUS = () => {
  return (
    <div className="bg-gray-200 dark:bg-gray-900 py-16 px-8">
      <div className="grid sm:grid-cols-2 px-3 gap-3">
        <div className="flex flex-col items-start justify-center gap-3 sm:pr-3">
          ...
          <p className="sm:mb-5 font-light text-gray-500 text-md dark:text-gray-400">
          We got you covered, drive yourself or have a  personal driver
        while you enjoy the views   
          </p>
          <div className='mx-auto sm:mx-0'>
            <Link href={'/contact'} className="block bg-primary hover:text-primary hover:bg-white hover:drop-shadow-lg text-white px-6 py-2 rounded-full shadow-sm my-3">
              {" "}
              Contact Us
            </Link>
          </div>
